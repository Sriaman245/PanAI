        ...
        <div>
            ...
            : (
                <div className='mt-3 h-full overflow-y-scroll text-sm text-slate-700'>
                    {/* every element inside .reset-tw (like <h1>, <ul>, <p>) will ignore Tailwind styles and go back to the browser’s default look. */}
                    <div className='reset-tw'>{/* reser-tw css added in index.css */}
                        {/* <Markdown> component, this turns into HTML tags like <h2>, <ul>, <li>, <p>, etc. */}
                        <Markdown>
                        {item.content}
                        </Markdown>
                    </div>
